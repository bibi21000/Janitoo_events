...
setup(
    name = 'janitoo_events',
    description = "Events components",
    long_description = "Events components",
    ...
    zip_safe = False,
    keywords = "cron,events,dawn,dusk",
    ...
    entry_points = {
        "janitoo.components": [
            "events.biocycle = janitoo_events.component:make_biocycle",
        ],
        "janitoo.threads": [
            "events = janitoo_events.thread:make_thread",
        ],
    },
    dependency_links = [
